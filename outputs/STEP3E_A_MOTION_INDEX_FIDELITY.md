...
| Scroll trajectory | Transform-first continuous parallax; central media dominates while satellites move independently. Motion is long, ease-out/settled and never springy. | One scrubbed GSAP timeline per stage moves main y/scale and three satellite x/y/rotation vectors. All 280 sampled intervals moved and every 0.18→0.50→0.82→0.50→0.18 sequence reversed direction. `invalidateOnRefresh` recalculates current geometry. | **Functional match. P3 open:** continuous micro-easing/settling remains a human-eye judgment. |
...
| Stage duration | Audited total Motion index height: 6,436 px at 1440×900 and 5,281 px at 390×844. Long spans are part of the site's identity. | Production export measured 5,833 px at 1440×900 and 4,931 px at 390×844: about 603 px/9.4% shorter desktop and 350 px/6.6% shorter mobile. Five stages remain continuous and readable; compact stage depth was increased to prevent identity/CTA collisions. | **P2 open:** human review should decide whether fidelity benefits from longer pacing before approval. |

## Responsive and runtime fidelity

The fixed matrix covers both sides of all structural breakpoints at 991, 767 and 479 px. No fixed-width or live-resize sample showed page overflow, disappearing satellites, unloaded stage media, non-finite transforms or duplicate Motion triggers. The 1440→360→1440 resize sequence remained in one document and finished with the original desktop composition restored.
...
- Local stage pacing is shorter than the audited Reference by about 9.4% desktop and 6.6% at 390×844; changing it is a human fidelity decision, not a functional fix.
